...
function RunButtonHandleKlickEvent()
{
	...
	{
		case 1:
			result = isNaN(inX) || isNaN(inY) || isNaN(inZ) ? msgInvalidNaN('X, Y, Z') : Uppgift1(Number(inX), Number(inY), Number(inZ));
			break;
		case 2:
			result = Uppgift2(inX);
			break;
		case 3:
			result = isNaN(inY) ? msgInvalidNaN('Y') : Uppgift3(inX, Number(inY));
			break;
		/*
		case 4:
